...
Partial Class frmImportPartsList
    ...
    Private Sub InitializeComponent()
        ...
        Me.ImportDataSet = New DCS.Quote.ImportDataSet()
        Me.lblPartLookup = New System.Windows.Forms.Label()
        Me.HQ_GetParts4LookupTableAdapter = New DCS.Quote.ImportDataSetTableAdapters.HQ_GetParts4LookupTableAdapter()
    ...
    Friend WithEvents ImportDataSet As DCS.Quote.ImportDataSet
    Friend WithEvents HQGetParts4LookupBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents HQ_GetParts4LookupTableAdapter As DCS.Quote.ImportDataSetTableAdapters.HQ_GetParts4LookupTableAdapter
End Class
