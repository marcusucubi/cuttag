...
#Region "DeletedProperties" 'dd_Deleted 12/28/11
...
#End Region
        ...
        Private Function CalcWeight() As Decimal
            'dd_Changed complete function 12/31/11
            Dim retValue As Decimal = 0
            For Each q As Detail In _Header.Details

                If q.IsWire Then
                    Dim w As Decimal = CType(q.QuoteDetailProperties, BOM.WireProperties).PoundsPer1000Feet
                    'dd_ToDo ' Handle non-Decimetor UOM for wires 
                    'retValue += q.Qty / 3.048 * q.Product.CopperWeightPer1000Ft / 1000  'product.copperweight not set 
