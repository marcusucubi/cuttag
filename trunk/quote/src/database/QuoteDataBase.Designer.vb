...
Partial Public Class QuoteDataBase
    ...
    Partial Public Class _QuotePropertiesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function Add_QuotePropertiesRow(ByVal QuoteID As Integer, ByVal PropertyID As Integer, ByVal PropertyName As String, ByVal PropertyStringValue As String, ByVal PropertyDecimalValue As Decimal, ByVal PropertyIntegerValue As Integer) As _QuotePropertiesRow
            Dim row_QuotePropertiesRow As _QuotePropertiesRow = CType(Me.NewRow,_QuotePropertiesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, QuoteID, PropertyID, PropertyName, PropertyStringValue, PropertyDecimalValue, PropertyIntegerValue}
    ...
    Partial Public Class _QuotePropertiesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `_QuoteProperties` (`QuoteID`, `PropertyID`, `PropertyName`, `Propert"& _ 
                "yStringValue`, `PropertyDecimalValue`, `PropertyIntegerValue`) VALUES (?, ?, ?, "& _ 
                "?, ?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("QuoteID", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "QuoteID", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `_QuoteProperties` SET `QuoteID` = ?, `PropertyID` = ?, `PropertyName` = ?"& _ 
                ...
                " ((? = 1 AND `PropertyID` IS NULL) OR (`PropertyID` = ?)) AND ((? = 1 AND `Prope"& _ 
                "rtyName` IS NULL) OR (`PropertyName` = ?)) AND ((? = 1 AND `PropertyStringValue`"& _ 
                " IS NULL) OR (`PropertyStringValue` = ?)) AND ((? = 1 AND `PropertyDecimalValue`"& _ 
                " IS NULL) OR (`PropertyDecimalValue` = ?)) AND ((? = 1 AND `PropertyIntegerValue"& _ 
                "` IS NULL) OR (`PropertyIntegerValue` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("QuoteID", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "QuoteID", Global.System.Data.DataRowVersion.Current, false, Nothing))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, QuoteID, PropertyID, PropertyName, PropertyStringValue, PropertyDecima"& _ 
                "lValue, PropertyIntegerValue FROM [_QuoteProperties]"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        ID, QuoteID, PropertyID, PropertyName, PropertyStringValue, Propert"& _ 
                "yDecimalValue, PropertyIntegerValue"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            [_QuoteProperties]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE  "& _ 
                "      (QuoteID = ?) AND (PropertyID = ?) AND (PropertyName = ?)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("QuoteID", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "QuoteID", Global.System.Data.DataRowVersion.Current, false, Nothing))
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal QuoteID As Global.System.Nullable(Of Integer), ByVal PropertyID As Global.System.Nullable(Of Integer), ByVal PropertyName As String, ByVal PropertyStringValue As String, ByVal PropertyDecimalValue As Global.System.Nullable(Of Decimal), ByVal PropertyIntegerValue As Global.System.Nullable(Of Integer), ByVal Original_ID As Integer, ByVal Original_QuoteID As Global.System.Nullable(Of Integer), ByVal Original_PropertyID As Global.System.Nullable(Of Integer), ByVal Original_PropertyName As String, ByVal Original_PropertyStringValue As String, ByVal Original_PropertyDecimalValue As Global.System.Nullable(Of Decimal), ByVal Original_PropertyIntegerValue As Global.System.Nullable(Of Integer)) As Integer
            If (QuoteID.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(QuoteID.Value,Integer)
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = Global.System.DBNull.Value
            ...
            If (Original_QuoteID.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_QuoteID.Value,Integer)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_PropertyName,String)
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_PropertyStringValue,String)
            End If
            If (Original_PropertyDecimalValue.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_PropertyDecimalValue.Value,Decimal)
            Else
            ...
            If (Original_PropertyIntegerValue.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(18).Value = CType(Original_PropertyIntegerValue.Value,Integer)
            Else
